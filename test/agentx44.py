...
import numpy as np
import random
from sneksnekAI import SnekGeymAI, Direction, Point
...
class Agent:
    def __init__(self):
        ...
        self.memory = deque(maxlen=MAX_MEMORY) # if exceeds memory, 
                                               # then automatically popleft() 
                                               # or remove elements from the left
    ...
    def train_long_memory(self):
        ...
        states, actions, rewards, next_states, dones = zip(*mini_sample) # extracts samples to independent axes
...
def train():
    ...
    while True:
        ...
        if done:
            ...
            print('Game: ' + str(agent.n_games), "Score: " + str(score), "High Score: " + str(best_score))
